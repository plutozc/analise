...
export const TECH_KEYWORDS: { topic: string; keyword: string; label: string }[] = [
  ...
  { topic: "dc-networking", keyword: "dcqcn|dctcp", label: "DC Transport" },
  { topic: "dc-networking", keyword: "timely.*algorithm|timely.*congestion|timely.*rdma|timely.*feedback", label: "TIMELY (CC)" },
